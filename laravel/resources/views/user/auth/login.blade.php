...
<div class="table lg:w-96 w-80 m-auto mt-10 mb-40">
    <div class="p-9 leading-normal text-gray-700 rounded border-4">
        <div class="col-md-8">
            <div class="card">
                <div class="mb-12 text-2xl text-yellow-500 text-center">Freetment</div>
                ...
                <div class="relative transition">
                    <form method="POST" action="{{ route('user.login') }}">
                        ...
                        <div class="mt-6">
                            <div class="block">
                                <button type="submit" class="bg-yellow-500 text-white border-transparent leading-4 h-auto pt-3 pb-3 pr-4 pl-4 rounded w-full hover:bg-yellow-600">
                                ログイン
                                </button>
                                <div class="mt-3">
                                    @if (Route::has('user.password.request'))
                                        <a class="text-xs text-gray-400 hover:underline" href="{{ route('user.password.request') }}">
                                        パスワードを忘れた方
                                        </a>
                                    @endif
                                </div>
