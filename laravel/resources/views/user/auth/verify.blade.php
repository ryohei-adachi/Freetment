            ...
            <div class="mb-48">
                ...
                <div class="mt-16">
                    ...
                    <form class="d-inline" method="POST" action="{{ route('user.verification.resend') }}">
                        @csrf
                        <button type="submit" class="mt-8 bg-yellow-400 text-white border-transparent leading-4 h-auto pt-3 pb-3 pr-4 pl-4 rounded text-base hover:bg-yellow-600">メールを再送</button>
                    </form>
            </div>
        </div>
    </div>
